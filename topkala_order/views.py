...
from topkala_order.models import Order
from topkala_product.models import Product


@login_required(login_url='/login')
def add_user_order(request):
    user_form = UserNewOrderForm(request.POST or None)
    ...
    if user_form.is_valid():
        ...
        product_id = user_form.cleaned_data.get('product_id')
        count = user_form.cleaned_data.get('count')
        if count < 0:
            count = 1
...
MERCHANT = '8d63501e-9498-11ea-a9b0-000c295eb8fc'
